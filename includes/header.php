...
<nav class="navbar">
    ...
    <ul class="nav-links">
       ...
       <li><a href="/pages/teams.php" class="<?= $current_page === 'teams' ? 'active' : '' ?>">Teams</a></li>
        <li><a href="/pages/players.php" class="<?= $current_page === 'players' ? 'active' : '' ?>">Players</a></li>
      <li><a href="/pages/matches.php" class="<?= $current_page === 'matches' ? 'active' : '' ?>">Matches</a></li>
       <li><a href="/pages/standings.php" class="<?= $current_page === 'standings' ? 'active' : '' ?>">Standings</a></li>
    </ul>
